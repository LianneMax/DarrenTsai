...
<span style="display:none;font-size:1px;color:#f5f7f9;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">My first out-of-state BRRRR rental, purchase to refinance: the real numbers, the real timeline, and the mistakes.</span>
...
<table role="presentation" class="wrap" cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;max-width:600px;background-color:#ffffff;border:1px solid #e6ebf0;">
  ...
  <tr>
    <td class="pad" style="padding:16px 40px 0 40px;font-family:${FONT};font-size:16px;line-height:26px;mso-line-height-rule:exactly;color:#6b7280;">
      Attached is the case study: the real numbers, the real timeline, and the mistakes behind my first out-of-state rental, start to finish using the BRRRR method.
    </td>
  </tr>
  <tr>
    <td class="pad" style="padding:16px 40px 0 40px;font-family:${FONT};font-size:16px;line-height:26px;mso-line-height-rule:exactly;color:#6b7280;">
      If you want to talk through how this applies to your own numbers, feel free to book a free 15-minute strategy call.
    </td>
  </tr>
